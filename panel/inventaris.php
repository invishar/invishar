...
<p class="pengantar">
  Barang milik Invishar sendiri &mdash; laptop, kamera, perangkat kerja.
...
<?php if (!$daftar): ?>
  <p class="kosong">Belum ada aset tercatat.</p>
<?php else: ?>
    ...
    <div class="form-aksi">
      ...
      <?php if ($sunting): ?>
        <button class="tbl tbl-bahaya" type="submit" name="aksi" value="hapus"
                data-pastikan="Hapus <?= e($sunting['nama']) ?> dari inventaris?">Hapus</button>
      <?php endif; ?>
    </div>
  </form>
</section>
